...
class SmsManProvider:
    # TODO: Add real Sms-man integration after secrets storage and compliance checks are implemented.
    ...
    def get_number(self, service_code: str, country_iso2: str, operator: str | None = None) -> ProviderNumber:
        raise NotImplementedError("SmsManProvider is a placeholder")
